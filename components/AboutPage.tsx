...
const AboutPage: React.FC<AboutPageProps> = ({ onBack }) => {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: "An era of significant industrial transformation. Under the strategic leadership of Mr. Ganga Bhishan Mittal, Kudu transitioned from a focused boutique operation into a structured manufacturing powerhouse. We dramatically expanded our technical footprint, serving critical international markets with unmatched consistency and operational excellence.",
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-slate-100 selection:text-slate-900 overflow-x-hidden">
      ...
      <section className="relative pt-44 pb-20 lg:pt-56 lg:pb-32 px-6 bg-gradient-to-br from-[#faf9f6] via-[#f7f5f0] to-[#f1efea] overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10 text-center">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-lg lg:text-3xl text-slate-500/80 font-medium leading-relaxed italic mb-8 opacity-90">
      ...
      <section className="py-24 lg:py-48 bg-white container mx-auto px-6 overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-12 pt-12 border-t border-slate-100">
              <div className="space-y-2">
                <p className="text-5xl lg:text-7xl font-serif font-medium text-slate-950 tracking-tighter tabular-nums leading-none">1969</p>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em]">Foundation</p>
              </div>
              <div className="space-y-2">
                <p className="text-5xl lg:text-7xl font-serif font-medium text-slate-950 tracking-tighter tabular-nums leading-none">800+</p>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] rounded-[48px] overflow-hidden shadow-2xl relative group bg-slate-50 border border-slate-100">
              <img
                src="https://ik.imagekit.io/yajas/Gemini_Generated_Image_yp3ddbyp3ddbyp3d.png"
                alt="Mr. Krishan Kumar Mittal Udyog Award"
            ...
            {/* National Award Card */}
            <div className="absolute bottom-4 right-4 bg-slate-950 p-6 rounded-[32px] text-white shadow-2xl max-w-[240px] border border-white/10">
              <div className="inline-flex p-3 rounded-xl bg-white/5 border border-white/10 mb-4">
                <Award size={24} className="text-slate-300" />
              </div>
              <h4 className="text-lg font-serif font-bold mb-2 tracking-tight">Udyog Patra Award</h4>
              <p className="text-[10px] text-slate-400 leading-relaxed font-medium">
                Honored by the National Government for contribution as a top-tier self-made industrialist.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 lg:py-64 bg-slate-50 border-y border-slate-100 relative overflow-hidden">
      ...
      <section className="py-32 lg:py-72 bg-white relative overflow-hidden">
        <div className="container mx-auto px-6 lg:px-24 max-w-[1600px] relative z-10">
          <div className="text-center mb-16 lg:mb-48">
            ...
            <h2 className="text-5xl lg:text-8xl font-serif font-bold text-slate-900 tracking-tight uppercase leading-none">Our <span className="text-slate-300 italic font-light lowercase">Timeline</span></h2>
          </div>
                  ...
                  <div className="p-6 lg:p-10 rounded-[32px] lg:rounded-[40px] bg-white border border-slate-100 shadow-[0_10px_60px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_100px_rgba(0,0,0,0.1)] transition-all duration-700 hover:-translate-y-4 group overflow-hidden w-full min-h-[300px] lg:min-h-[500px] flex flex-col justify-between ml-4 lg:ml-0">
                    <div className="space-y-4 lg:space-y-6 relative z-10">
                      <div className="flex items-center justify-between">
                        <p className="text-2xl lg:text-4xl font-serif font-medium text-slate-950 tabular-nums leading-none tracking-tighter">
                          {ms.year}
                        </p>
      ...
      <section className="py-24 lg:py-48 px-6 bg-slate-950 relative overflow-hidden rounded-[48px] lg:rounded-[64px] mx-6 mb-24 text-center">
        ...
        <div className="container mx-auto relative z-10 space-y-12 lg:space-y-16">
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-4xl lg:text-8xl font-serif font-bold text-white mb-8 leading-[0.9] tracking-tighter uppercase">
              Excellence <br />
