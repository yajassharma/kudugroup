      ...
      <div className="max-w-7xl mx-auto px-4 mb-12 lg:mb-32">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-8xl font-serif font-bold text-slate-900 tracking-tighter leading-[0.9] uppercase">
            Voices of <span className="italic font-light text-transparent bg-clip-text bg-gradient-to-r from-slate-600 via-slate-400 to-slate-300 lowercase">Success</span>
          </h2>
        </div>
      </div>
          ...
          {duplicatedReviews.map((rev, idx) => (
            ...
            >
              ...
              <div className="flex space-x-1 mb-4 sm:mb-6 lg:mb-10">
                {[1, 2, 3, 4, 5].map(i => <Star key={i} size={12} className="sm:w-[14px] sm:h-[14px] text-amber-400" fill="currentColor" />)}
              </div>
              ...
              <div className="flex items-center pt-6 sm:pt-8 lg:pt-12 border-t border-slate-50">
                <div>
