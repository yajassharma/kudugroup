      ...
      >
        ...
        <div className="text-center">
          <motion.h1
            ...
            className="font-serif text-3xl lg:text-6xl font-light text-black uppercase mb-4"
          >
            KUDU GROUP
          </motion.h1>
          <motion.div
          ...
          <motion.p
            ...
            className="text-[12px] font-bold tracking-[0.1em] text-black/30 uppercase"
          >
            Textile Excellence Since 1969
          </motion.p>
        </div>
      </motion.div>
